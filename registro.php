		...
		<div class="card">
			...
			<div class="card-body">
					<div class="input-group form-group">
						...
						<input type="text" class="form-control" placeholder="Cédula" id="txtCedula" onKeyPress="return soloNumeros(event)">						
                    </div>
                    <div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-user"></i></span>
						</div>
						<input type="text" class="form-control" placeholder="Nombre" id="txtNombre" onKeyPress="return soloLetras(event)">						
                    </div>
                    <div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-user"></i></span>
						</div>
						<input type="text" class="form-control" placeholder="Apellido" id="txtApellido" onKeyPress="return soloLetras(event)">						
                    </div>
                    <div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-user"></i></span>
						</div>
						<input type="text" class="form-control" placeholder="Edad" id="txtEdad" onKeyPress="return soloNumeros(event)">						
					</div>
					<div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-key"></i></span>
						</div>
						<input type="text" class="form-control" placeholder="Contraseña" id="txtClave" >
					</div>					
					<div class="form-group">
						<input id="btnRegistrarse" type="submit" value="Registrarse" class="btn float-right login_btn">
					</div>
			</div>
